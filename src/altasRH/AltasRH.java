...
public class AltasRH extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DateTimeFormatter fechaNac = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        ZonedDateTime fechaNac2 = ZonedDateTime.parse((CharSequence) jDateChooser1, fechaNac);
        String curp = jTextField4.getText();
        String rfc  = jTextField5.getText();
        float sueldoBruto = Float.parseFloat( jTextField6.getText());
        DateTimeFormatter fechaIng = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        ZonedDateTime fechaIng2 = ZonedDateTime.parse((CharSequence) jDateChooser2, fechaIng);
        
        
        CRH.insertDatos(numero, nombre, apellido, fechaNac2, curp, rfc, sueldoBruto, fechaIng2);
